...
$query_select_order = mysqli_query($connection, "SELECT orders.*, user.name, user.phone, user.address FROM orders JOIN user ON orders.id_user = user.id_user WHERE orders.status != 1 AND orders.status != 5");
